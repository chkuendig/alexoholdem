...
//
//    //--------------------------------------------------------------------
//    public static PostFlopCaseSet riverCaseSet(int forTurnIndex)
//    {
...
//            byte riverCases[])
//    {
//        Set<PostFlopCase> caseBuffer = new TreeSet<PostFlopCase>();
...
//
//            Flop isoFlop  = hole.isoFlop(flop[0], flop[1], flop[2]);
...
//                PostFlopCaseSet.valueOf(caseBuffer).ordinal();
//    }
}
