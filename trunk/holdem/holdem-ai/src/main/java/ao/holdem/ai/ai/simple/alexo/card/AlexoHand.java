package ao.holdem.ai.ai.simple.alexo.card;
...
{
    //--------------------------------------------------------------------
    public static int valueOf(AlexoCard a,
                              AlexoCard b,
                              AlexoCard c)
    {
        ...
        int valA = inOrder.get(0).ordinal(),
            valB = inOrder.get(1).ordinal(),
            valC = inOrder.get(2).ordinal();
